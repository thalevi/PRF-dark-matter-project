...
signature scheme can be built from any OWF $F$ that has an MPC protocol to
evaluate it, by setting the public key to $y = F(x)$ for a random secret $x$,
