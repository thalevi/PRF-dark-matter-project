...
\hline
\multirow{2}{*}{Protocol} & & \multicolumn{3}{c|}{Runtime} & \multirow{2}{*}{\makecell{Output \\ Size}} & \multirow{2}{*}{Preprocessing} & \multirow{2}{*}{Comm.}\\
& & Server & Client & Parallel & & &\\
\hline\hline
\multirow{2}{*}{23-OPRF} & Key Update & 0.65 & - & - &  &  & \\
