...
\item Can the concrete MPC protocols given in~\cite{boneh2018-darkmatter} be further improved? Can preprocessing be eliminated or realized at a low amortized cost? This motivates an additional design criterion: compatibility with recent advances in pseudorandom correlation generators.
\end{itemize}
