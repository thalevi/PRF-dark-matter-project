...
\begin{itemize}
\item
What about simpler symmetric primitives such as OWFs and PRGs? MPC protocols for these primitives are motivated by many applications, including Picnic-style post-quantum digital signatures~\cite{Picnicrefs}. 
\item Are there similar weak PRF candidates where the input, output, and key are all over $\Z_2$? This too is motivated by several applications. 
...
\paragraph{Eliminating preprocessing.}
