...
\item Can the concrete MPC protocols given in~\cite{boneh2018-darkmatter} be further improved? Can preprocessing be eliminated at a low cost? 
\item 
\end{itemize}
...
Motivated by the above challenges, we make the following contributions.
