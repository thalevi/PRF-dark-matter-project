...
% TODO: something in Sections/distributed_protocols breaks the build when iffull is true
%\input{Sections/distributed_protocols}

\input{Sections/applications}

% TODO: Something in Sections/evaluation breaks the build when iffull is true
