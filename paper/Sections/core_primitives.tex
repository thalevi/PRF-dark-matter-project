...
\end{enumerate}
\greg{The list is repetitive of the preceeding sentence, is only one meant to appear?}
\fi
...
\greg{I think we have two copies of the following definition? (one here, one in appendix}
