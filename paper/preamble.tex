...
\newcommand{\protbox}[2]{\centering\resizebox{\finalsize\textwidth}{!}{\centering\fbox{\small\hbox{\quad\begin{minipage}{\boxsize\columnwidth}\begin{center}{\bf #1}\end{center}#2\end{minipage}\quad}}}}
