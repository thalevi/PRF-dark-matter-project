...
\ifcomments
    ...
    \newcommand{\itai}[1]{\textsf{\color{Brown}{[Itai: {#1}]}}}
\else
    \newcommand{\mahimna}[1]{}
    \newcommand{\yuval}[1]{}
    \newcommand{\greg}[1]{}
...
\iffull\newcommand{\finalsize}{1}\else\newcommand{\finalsize}{0.87}\fi
\newcommand{\figtextsize}{\iffull\normalsize\else\small\fi}
...
\newcommand{\lncsresize}[1]{\iffull#1\else\resizebox{\textwidth}{!}{#1}\fi}
...
\setitemize{label=$\bullet$,topsep=0pt}
